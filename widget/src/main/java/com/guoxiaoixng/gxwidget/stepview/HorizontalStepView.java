...
public class HorizontalStepView extends LinearLayout implements HorizontalStepsViewIndicator.OnDrawIndicatorListener
{
    ...
    private int mUnComplectedTextColor = ContextCompat.getColor(getContext(), R.color.fcwidget_fc_c3);//定义默认未完成文字的颜色;
    private int mComplectedTextColor = ContextCompat.getColor(getContext(), R.color.fcwidget_fc_c12);//定义默认完成文字的颜色;
    private int mTextSize = 15;//default textSize
    ...
    private void init()
    {
        View rootView = LayoutInflater.from(getContext()).inflate(R.layout.fcstepview_horizontal_stepview, this);
     ...
     * @param defaultIcon
     */
    public HorizontalStepView setStepsViewIndicatorUnCompleteIcon(Drawable defaultIcon)
    {
        mStepsViewIndicator.setUnCompleteIcon(defaultIcon);
        return this;
    }
     ...
     * @param attentionIcon
     */
    public HorizontalStepView setStepsViewIndicatorErrorIcon(Drawable attentionIcon)
    {
        mStepsViewIndicator.setErrorIcon(attentionIcon);
        return this;
    }
