...
public class VerticalStepView extends LinearLayout implements VerticalStepViewIndicator.OnDrawIndicatorListener
{
    ...
    private int mUnComplectedTextColor = ContextCompat.getColor(getContext(), R.color.fcwidget_fc_c12);//定义默认未完成文字的颜色;
    ...
    private void init()
    {
        View rootView = LayoutInflater.from(getContext()).inflate(R.layout.fcstepview_vertical_stepview, this);
