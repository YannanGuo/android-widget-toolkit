...
public class VerticalStepViewIndicator extends View {
    ...
    private int mUnCompletedLineColor = ContextCompat.getColor(getContext(), R.color.fcwidget_fc_c12);//定义默认未完成线的颜色  definition mUnCompletedLineColor
    ...
    private void init() {
        ...
        mAttentionIcon = ContextCompat.getDrawable(getContext(), R.drawable.fcwidget_error);//正在进行的icon
        mDefaultIcon = ContextCompat.getDrawable(getContext(), R.drawable.fcwidget_error);//未完成的icon
