...
public interface IWheelPicker {
     ...
     * 设置滚轮Item选中监听器
     *
     * @param listener 滚轮Item选中监听器{@link SCWheelPicker.OnItemSelectedListener}
     */
    void setOnItemSelectedListener(SCWheelPicker.OnItemSelectedListener listener);
     ...
     * {@link SCWheelPicker.OnItemSelectedListener}回调监听或调用
     ...
     * through {@link SCWheelPicker.OnItemSelectedListener} or call
     ...
     * 前所根据这些参数改变的一些属性，比如
     * {@link SCWheelPicker.OnWheelChangeListener}和
     * {@link SCWheelPicker.OnItemSelectedListener}监听器中方法参数的值，因
     * 此你总该在调用该方法后考虑到相关影响
     ...
     * {@link SCWheelPicker.OnWheelChangeListener} and
     * {@link SCWheelPicker.OnItemSelectedListener}, so you must always
     ...
     * @param data 数据列表
     */
    void setData(List<IPickerModel> data);
     ...
     * @see SCWheelPicker.OnWheelChangeListener
     */
    void setOnWheelChangeListener(SCWheelPicker.OnWheelChangeListener listener);
    ...
    /**
     * 设置滚轮选择器数据项的对齐方式
     * 默认对齐方式为居中对齐{@link SCWheelPicker#ALIGN_CENTER}
     * <p>
     * Set alignment of WheelPicker
     * The default alignment of WheelPicker is {@link SCWheelPicker#ALIGN_CENTER}
     *
     * @param align 对齐方式标识值
     *              该值仅能是下列值之一：
     *              {@link SCWheelPicker#ALIGN_CENTER}
     *              {@link SCWheelPicker#ALIGN_LEFT}
     *              {@link SCWheelPicker#ALIGN_RIGHT}
     */
